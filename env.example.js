/**
 * Firebase Connection Environment Configuration Template
 * 
 * Instructions:
 * 1. Copy this file and rename it to 'env.js' in the same directory.
 * 2. Replace the placeholder strings below with the credentials from your Firebase Console.
